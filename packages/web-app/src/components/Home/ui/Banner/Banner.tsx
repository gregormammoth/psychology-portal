  ...
  return (
    <div className="relative bg-indigo-700 overflow-hidden">
      <div className="absolute inset-0 animate-pulse-slow">
        ...
        />
        <div className="absolute inset-0 bg-primary-100 mix-blend-multiply animate-gradient" />
      </div>
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-24 sm:px-6 lg:py-40 lg:px-8">
        <div className="text-left max-w-2xl animate-fade-in">
          <h1 className="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl animate-slide-up">
            Your Journey to Mental Wellness
          </h1>
          <p className="mt-6 text-xl text-primary-100 animate-slide-up-delay">
