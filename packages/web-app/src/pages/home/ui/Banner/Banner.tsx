  ...
  return (
    <div className="relative bg-indigo-700">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-primary-100 mix-blend-multiply" />
      </div>
        ...
        <div className="text-left max-w-2xl">
          ...
          <div className="mt-10 space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="inline-flex items-center bg-[#0088cc] text-white py-3 px-6 rounded-md hover:bg-[#0077b3] transition duration-300"
              >
              ...
              <a
                href="#"
                className="inline-flex items-center bg-[#25D366] text-white py-3 px-6 rounded-md hover:bg-[#22c55e] transition duration-300"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
